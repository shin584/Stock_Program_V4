...
class MarketScanner:
    ...
    def run_scan(
        ...
        with ThreadPoolExecutor(max_workers=worker_count) as executor:
            future_to_row = {
                executor.submit(self._process_stock, row): row for row in ticker_rows
            }
    ...
    def _process_stock(self, ticker_row: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            df = self.data_fetcher.get_and_process_data(ticker)
